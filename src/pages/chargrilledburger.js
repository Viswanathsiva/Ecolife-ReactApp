...
export default function chargrilledburger() {
    return (
        <div>
            ...
            <section className="breadcrumb-area">
                ...
                <div className="row">
                    ...
                    <div className="breadcrumb-content">
                        <h1 className="breadcrumb-hrading">Chargrilled Burger</h1>
                ...
                <div className="row">
                    ...
                    <div className="product-details-img product-details-tab">
                        ...
                        <a href=" "className="active" data-image="assets/images/product-image/organic/product-11.jpg" data-zoom-image="assets/images/product-image/organic/zoom/1.jpg">
                            <img src="assets/images/product-image/organic/55.jpg" alt="" />
                        </a>
                    ...
                    <div className="product-details-content">
                        ...
                        <p>The most important thing is to snack on things that are filled with real food and nourishing ingredients that will leave you feeling energised and happy.</p>
