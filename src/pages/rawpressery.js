...
export default function rawpressery() {
    return (
        <div>
...
<section className="breadcrumb-area">
                ...
                <div className="row">
                    ...
                    <div className="breadcrumb-content">
                        <h1 className="breadcrumb-hrading">Raw Pressery Coconut Water</h1>
                ...
                <div className="row">
                    ...
                    <div className="product-details-img product-details-tab">
                        ...
                        <a href=" "className="active" data-image="assets/images/product-image/organic/product-11.jpg" data-zoom-image="assets/images/product-image/organic/zoom/1.jpg">
                            <img src="assets/images/product-image/organic/coco-water1.jpg" alt="" />
                        </a>
                        <a href=" "data-image="assets/images/product-image/organic/product-9.jpg" data-zoom-image="assets/images/product-image/organic/zoom/2.jpg">
                            <img src="assets/images/product-image/organic/coco-water.jpg" alt="" />
                        </a>
                    ...
                    <div className="product-details-content">
                        <h2>Raw Pressery Coconut Water</h2>
                        ...
                        <p>The more concentrated sugar and calories in fruit juice can lead to obesity and inappropriate weight gain. Excessive weight gain is associated with high blood pressure, hypertension, stroke, diabetes and other negative health issues later in life.</p>
